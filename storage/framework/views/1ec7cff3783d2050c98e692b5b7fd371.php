...
<head>
    ...
    <title>Crear Sopa de Letras</title>
    <style>
        ...
        .word-row:first-child .remove { visibility: hidden; }
    </style>
</head>
<body>
    <div class="card">
        <h1>Crear Sopa de Letras</h1>
        ...
        <form method="POST" action="<?php echo e(route('teacher.wordsearches.store')); ?>">
            <?php echo csrf_field(); ?>

            <label for="activity_id">Actividad (word_search)</label>
            ...
            <div style="display:flex; gap:2rem;">
                <div>
                    ...
                    <input type="number" name="rows" id="rows" value="10" min="2" max="30" required>
                </div>
                <div>
                    <label for="columns">Columnas</label>
                    <input type="number" name="columns" id="columns" value="10" min="2" max="30" required>
                </div>
            </div>
            ...
            <button type="submit" class="primary">Generar sopa</button>
        </form>
    ...
    <script>
        ...
        function reindex() {
            body.querySelectorAll('tr.word-row').forEach((row, i) => {
        ...
        body.addEventListener('click', (event) => {
            ...
            if (body.querySelectorAll('tr.word-row').length > 1) {
...
</html><?php /**PATH /var/www/html/resources/views/teacher/activities/wordsearch/create.blade.php ENDPATH**/ ?>