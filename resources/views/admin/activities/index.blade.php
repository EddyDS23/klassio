...
@php
    ...
    $typeColors = ['word_search' => 'bg-amber-100 text-amber-800', 'crossword' => 'bg-violet-100 text-violet-800', 'matching' => 'bg-cyan-100 text-cyan-800', 'kahoot' => 'bg-rose-100 text-rose-800', 'roulette' => 'bg-fuchsia-100 text-fuchsia-800'];
