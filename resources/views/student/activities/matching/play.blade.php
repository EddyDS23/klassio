...
<div class="wrap">
    <div class="card">
        ...
        <p class="scoreline">
            ...
            / {{ $maxScore }} · Parejas: <strong id="matched-count">{{ count($correctIds) }}</strong>/{{ $items->count() }}
        </p>
        ...
        <div class="layout">
            <div class="col">
                ...
                @foreach ($items as $item)
                    <div class="card-item left" data-item-id="{{ $item->id }}" {{ in_array($item->id, $correctIds) ? 'data-matched' : '' }}>
                        {{ $item->left_text }}
                    </div>
                @endforeach
            </div>
