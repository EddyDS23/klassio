...
<body>
    ...
    <script>
        ...
        */
        ...
        /*
         * grid ya está convertido a array por el cast del modelo Crossword.
         */
        ...
        */
        ...
        WORDS.forEach(word => {
            ...
            for (let i = 0; i < length; i++) {
                ...
                const column = word.direction === 'horizontal'
                    ? word.column + i
                    : word.column;
            ...
            /*
             * El número de pista se coloca solamente
             * en la primera celda de la palabra.
             */
            if (cellNumbers[word.row][word.column] === null) {
                ...
                wordClueNumbers[word.id] =
                    cellNumbers[word.row][word.column];
            }
        });
        ...
        */
        ...
        const cluesHorizontal =
            document.getElementById('clues-horizontal');

        const cluesVertical =
            document.getElementById('clues-vertical');
        ...
        WORDS.forEach(word => {
            ...
            clue.textContent =
                `${wordClueNumbers[word.id]}. ${word.clue}`;
        ...
        async function submitWord(word) {
            ...
            */
            ...
            if (clueElement) {
                ...
                clueElement.style.textDecoration =
                    'line-through';
            }
